...
<section class="section d-flex">
        ...
        <h5 class="banner bg-light rounded text-dark mb-3 px-2 py-2 "><marquee>Buku Terbaru dari Kami, Selamat Membaca</marquee></h5>
        <div class="row mb-5">
            ...
            <div class="col-md-8 ">
             ...
             <h5 class="card-title text-dark">Judul Buku</h5>
                ...
                <a href="baca" class="btn btn-primary mt-4">Baca</a>
              </div>
            </div>
            </div>
        </div></div>
